...
"selection-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_9.setText(_translate("MainWindow", "Добавить сотрудника"))
        self.pushButton_10.setText(_translate("MainWindow", "Добавить объект"))
        ...
        self.pushButton_6.setText(_translate("MainWindow", "Материалы"))
